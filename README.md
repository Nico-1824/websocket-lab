...
You are capped at 256 characters in a message and that message will be sent encoded with a super secret encryption algorithm. Users will recieve the encoded message. To decode the message you can press the decode button and it will be live translated. 
