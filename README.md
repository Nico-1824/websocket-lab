...
The client server is stood up when the webpage is opened automatically and you are capped at 256 characters in a message and that message will be sent encoded with a super secret encryption algorithm. The server will receive the message, encode it, and then return the encoded message. To decode the message you can press the decode button and it will be live translated. 
...
Now feel free to start chatting with the server and see the messages!
